...
import Auth0WebAuthNative from './auth0WebAuthNative';

describe('sessionTypes/Auth0WebAuthNative', function() {
  ...
  beforeEach(function() {
    ...
    getStoredSession = sinon
      .stub(Auth0WebAuthNative.prototype, '_getStoredSession')
      .returns({});
    isAuthenticated = sinon
      .stub(Auth0WebAuthNative.prototype, 'isAuthenticated')
      .returns(true);
    webAuth = sinon.stub(auth0).returns(webAuthSession);
  });
  ...
  describe.skip('clearCurrentApiToken', function() {
    context(
  ...
  describe.skip('getCurrentAccessToken', function() {
  ...
  describe.skip('getCurrentApiToken', function() {
  ...
  describe.skip('handleAuthentication', function() {
  ...
  describe.skip('isAuthenticated', function() {
    let auth0WebAuth;
  ...
  describe.skip('_checkSession', function() {
  ...
  describe.skip('_defaultOnRedirect', function() {
  ...
  describe.skip('_getRedirectPathname', function() {
    afterEach(function() {
  ...
  describe.skip('_getStoredSession', function() {
    let auth0WebAuth;
    let expectedSessionInfo;
    let localStorage;
    let session;
  ...
  describe.skip('_getUpdatedSession', function() {
  ...
  describe.skip('_generateUnauthorizedError', function() {
    let auth0WebAuth;
  ...
  describe.skip('_parseHash', function() {
  ...
  describe.skip('_scheduleTokenRenewal', function() {
    let auth0WebAuth;
    let clock;
    let expectedDelay;
  ...
  describe.skip('_storeSession', function() {
    let auth0WebAuth;
    let expectedSessionInfo;
    let localStorage;
